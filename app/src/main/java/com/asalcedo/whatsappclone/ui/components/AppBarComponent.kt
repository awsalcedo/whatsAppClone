...
import com.asalcedo.whatsappclone.R
import com.asalcedo.whatsappclone.ui.theme.Gray
import com.asalcedo.whatsappclone.ui.theme.White
...
fun AppBarComponent() {
    Row(
        ...
        Text(
            text = stringResource(id = R.string.whatsaap_title),
            style = TextStyle(
                fontSize = 20.sp,
